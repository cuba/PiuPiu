...
extension Sequence {
  func asyncMap<T>(_ callback: @escaping (Element) async throws -> T) async rethrows -> [T] {
    var results: [T] = []
    for element in self {
  ...
  func asyncCompactMap<T>(_ callback: @escaping (Element) async throws -> T?) async rethrows -> [T] {
    var results: [T] = []
    for element in self {
  ...
  func asyncFlatMap<T>(_ callback: @escaping (Element) async throws -> [T]) async rethrows -> [T] {
    var results: [T] = []
    for element in self {
  ...
  func asyncForEach(_ callback: @escaping (Element) async throws -> Void) async rethrows {
    for element in self {

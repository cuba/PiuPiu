...
final actor URLRequestDispatcher: DataDispatcher, DownloadDispatcher, UploadDispatcher {
  ...
  public func adaptedData(
    ...
    return await Response(body: data, urlRequest: urlRequest, urlResponse: adaptedResponse)
  }
  ...
  public func adaptedDownload(
    ...
    let adaptedResponse = try await adaptResponse(urlResponse: urlResponse, for: urlRequest, using: responseAdapter)
    return await Response(body: destination, urlRequest: urlRequest, urlResponse: adaptedResponse)
  }
